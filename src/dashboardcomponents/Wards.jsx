  ...
  const Wards = () => {
    ...
    const [selectedListId, setSelectedListId] = useState(null); // State to manage selected list ID for Assign Bed Popup
    ...
    const fetchEligibleStaff = async () => {
      try {
        ...
        handleSnackbarOpen(
          'error',
          'Error fetching eligible staff members. Please try again.'
        );
      }
    };
    ...
    const handleOpenAssignPopup = (listId) => {
      ...
      setSelectedListId(listId); // Set the selected listId to pass to AssignBedPopup
    };
    ...
    return (
      <Box sx={{ p: 3 }}>
        ...
        <AssignBedPopup
          ...
          title="Assign a Bed"
          listId={selectedListId} // Pass the selected listId to AssignBedPopup
        >
          <Grid container spacing={2}>
